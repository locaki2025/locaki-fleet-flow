-- Configurar cron job para executar função de faturas recorrentes
-- Executa todos os dias às 09:00 (horário UTC)
SELECT cron.schedule(
  ...
  SELECT
    net.http_post(
        url:='https://pfkiedrazodgsssohwzp.supabase.co/functions/v1/generate-recurring-invoices',
